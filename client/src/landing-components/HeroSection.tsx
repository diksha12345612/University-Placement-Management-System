              ...
              <form onSubmit={authTab === "signin" ? handleLogin : step === 1 ? handleSendOTP : handleVerifyOTP}>
                {authTab === "register" && step === 2 ? (
                  <div className="form-group" style={{ textAlign: 'left', marginTop: '1rem' }}>
                    ...
                    <input type="text" value={otp} onChange={(e) => setOtp(e.target.value.replace(/\D/g, '').slice(0, 6))} placeholder="Enter 6-digit OTP" required style={{ width: '100%', padding: '1.5rem 1.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)', background: 'var(--bg-primary)', color: 'var(--text-primary)', outline: 'none', fontSize: '1.1rem' }} />
                  </div>
                ) : (
                  <>
                    {authTab === "register" && (
                      <div className="form-group" style={{ textAlign: 'left' }}>
                        ...
                        <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Enter your full name" required style={{ width: '100%', padding: '1.5rem 1.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)', background: 'var(--bg-primary)', color: 'var(--text-primary)', outline: 'none', fontSize: '1.1rem' }} />
                      </div>
                    )}
                    {authTab === "register" && (
                      <div className="form-group" style={{ textAlign: 'left', marginTop: '1rem' }}>
                        <label style={{ color: 'var(--text-primary)', fontWeight: 500, display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem' }}>Role</label>
                        <select value={role} onChange={(e) => setRole(e.target.value)} required style={{ width: '100%', padding: '1.5rem 1.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)', background: 'var(--bg-primary)', color: 'var(--text-primary)', outline: 'none', fontSize: '1.1rem' }}>
                    ...
                    <div className="form-group" style={{ textAlign: 'left', marginTop: '1rem' }}>
                      ...
                      <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter your email" required style={{ width: '100%', padding: '1.5rem 1.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)', background: 'var(--bg-primary)', color: 'var(--text-primary)', outline: 'none', fontSize: '1.1rem' }} />
                    </div>
                    <div className="form-group" style={{ textAlign: 'left', marginTop: '1rem' }}>
                      <label style={{ color: 'var(--text-primary)', fontWeight: 500, display: 'block', marginBottom: '0.5rem', fontSize: '0.9rem' }}>Password</label>
                      <div style={{ position: 'relative' }}>
                        <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder={authTab === "register" ? "Min 6 characters" : "Enter your password"} required style={{ width: '100%', padding: '1.5rem 1.75rem', borderRadius: '0.5rem', border: '1px solid var(--border)', background: 'var(--bg-primary)', color: 'var(--text-primary)', outline: 'none', fontSize: '1.1rem' }} />
